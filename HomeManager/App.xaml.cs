...
namespace HomeManager
{
    public partial class App : Application
    {
        ...
        static App()
        {
            Container = new SingletoneContainer();
        }
        #endregion
        ...
        {
            //Do not perform save operation if database wasn't fully loaded
            if (!_databaseLoaded)
                return;
        ...
        #region Application open/close event handlers
